...
?>		<div style="float: right;">
		...
		<p align="center">
		<input type="button" name="regi" value ="직원 ID 결재" onclick="location.href='sign_list.php'"
		style="WIDTH: 400pt; HEIGHT: 80pt; font-size:20pt;">
		</p>
	
	
		<p align="center">
		<input type="button" name="payment" value ="외부인원 ID 결재" onclick="location.href='sign_list_guest.php'"
		style="WIDTH: 400pt; HEIGHT: 80pt; font-size:20pt;">
		</p>
<?php        
    }
