...
?>		<div style="float: right;">
		...
		<p align="center">
		<input type="button" name="regi" value ="직원 ID 현황" onclick="location.href='registration_list.php'"
		style="WIDTH: 400pt; HEIGHT: 80pt; font-size:20pt;">
		</p>
	
	
		<p align="center">
		<input type="button" name="payment" value ="외부인원 ID 현황" onclick="location.href='registration_guest_list.php'"
		style="WIDTH: 400pt; HEIGHT: 80pt; font-size:20pt;">
		</p>
<?php        
    }
